Project Setup
This project is a form component built using Vite, React, and SCSS. It utilizes various libraries and tools to enhance the form functionality and styling. Follow the steps below to set up the project:
...
Customize the form styling by editing the SCSS styles in the src/styles/DishForm.scss file.
